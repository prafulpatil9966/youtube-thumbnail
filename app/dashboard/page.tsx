    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-red-500">Saved Streams</h1>
              ...
              <div key={item.id} className="bg-gray-800 p-6 rounded-xl border border-gray-700 flex flex-col md:flex-row gap-6 shadow-lg relative group">
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p>Stream End:</p><p className="text-gray-400 text-sm whitespace-pre-wrap line-clamp-3 mb-4">ggs, live on YT if anyone wants to stop by — PatilPlaysYT</p>
                  </div>
